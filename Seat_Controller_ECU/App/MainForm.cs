...
namespace SerialPanel.WinForms
{
    public class MainForm : Form
    {
        ...
        TextBox txtTrace = new()
        {
            ...
            Height = 280, Anchor = AnchorStyles.Left | AnchorStyles.Top | AnchorStyles.Right | AnchorStyles.Bottom
        };
        ...
        // --- Runtime ---
readonly System.IO.Ports.SerialPort _port = new();
readonly System.Windows.Forms.Timer _t1 = new() { Interval = 1000 };
readonly System.Windows.Forms.Timer _t2 = new() { Interval = 1000 };
        ...
        public MainForm()
        {
            ...
            // Trace (span all)
            var tracePanel = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.TopDown, WrapContents = false, AutoSize = true };
            var traceLabel = MakeHeader("Trace");
            traceLabel.Font = new Font(traceLabel.Font.FontFamily, 18, FontStyle.Bold);
            tracePanel.Controls.Add(traceLabel);
            txtTrace.Width = ClientSize.Width - 60;
            tracePanel.Controls.Add(txtTrace);
        ...
        void Port_DataReceived(object? sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                BeginInvoke(new Action(() => Trace($"<- {data.TrimEnd()}")));
            }
            catch (Exception ex)
            {
        ...
        bool TrySetInterval(string text, System.Windows.Forms.Timer t)
        {
